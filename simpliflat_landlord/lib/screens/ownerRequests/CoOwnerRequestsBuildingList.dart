...
class CoOwnerRequestBuildingList extends StatefulWidget {

  final Owner user;


  CoOwnerRequestBuildingList(this.user);

  @override
  State<StatefulWidget> createState() {
    return CoOwnerRequestBuildingListState(this.user);
  }

}

class CoOwnerRequestBuildingListState extends State<CoOwnerRequestBuildingList> {
  ...
  CoOwnerRequestBuildingListState(this.user);
