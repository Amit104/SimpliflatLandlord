  ...
  Widget getBody(BuildContext scaffoldC, User user) {
    return StreamBuilder(
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        return Consumer<LandlordRequestsModel>(builder: (BuildContext context,
            LandlordRequestsModel landlordRequestsModel, Widget child) {
          return landlordRequestsModel.load
              ...
              : ListView.separated(
                  ...
                  itemBuilder: (BuildContext context, int position) {
                    ...
                    LandlordRequest req = LandlordRequest.fromJson(
                        request, documents[position].documentID);

                    return Dismissible(
                      //TODO: Dismissible giving error. Dont use it
                      key: Key(documents[position].documentID),
                      confirmDismiss: (direction) {
                        return rejectRequest(req, scaffoldC);
                      },
                      child: Card(
                        child: ListTile(
                          title: Text(
